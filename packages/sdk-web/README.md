...
说明：
- 当前发布包提供浏览器基础能力，React 项目可以通过 `@luciaocr/react` 复用同一套能力
...
import { destroyOCR, initOCR, recognize } from "@luciaocr/web";
...
```js
import { initOCR } from "@luciaocr/web";
