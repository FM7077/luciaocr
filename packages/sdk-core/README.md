...
```js
import { parseGeneral } from "@luciaocr/core";
...
```js
import { parseIdCard, validateIdCard } from "@luciaocr/core";
...
```js
import { parseBankCard } from "@luciaocr/core";
...
```js
import { parseDriverLicenseAuto } from "@luciaocr/core";
...
```js
import { validateIdCard } from "@luciaocr/core";
...
```js
import { validateBankCard, validateBankCardExpiry } from "@luciaocr/core";
...
```js
import { validatePhone, validateEmail } from "@luciaocr/core";
...
```js
import { OCRError } from "@luciaocr/core";
